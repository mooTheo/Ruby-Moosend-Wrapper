...
module SwaggerClient
  ...
  class Criterion
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Subscriteria')
        self.subscriteria = attributes[:'Subscriteria']
      end
    ...
    def hash
      [comparer, custom_field_id, date_from, date_to, field, id, properties, segment_id, subscriteria, value].hash
    end
